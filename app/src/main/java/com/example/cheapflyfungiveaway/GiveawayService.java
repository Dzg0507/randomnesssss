...
public class GiveawayService extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        PendingIntent pendingIntent = PendingIntent.getBroadcast(this, 0, giveawayIntent, PendingIntent.FLAG_IMMUTABLE);
        ...
        mDatabase.child("donations").addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for (DataSnapshot donationSnapshot : snapshot.getChildren()) {
                    DonationActivity donation = donationSnapshot.getValue(DonationActivity.class);
